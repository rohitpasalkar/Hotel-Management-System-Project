      ...
      public class hotelapp extends JFrame implements ActionListener,ItemListener
       {
          JLabel l10,l9,l1,l2,l3,l4,l5,l6,l7,l8,l11,l12,l13;
           ...
           JRadioButton r1,r2;
            ...
            public hotelapp()
            {
		     ...
		     c2=new JComboBox(b);
		     String id[]=new String[]{"Adhar Card","Pan Card","Driving Liscence","Passport","Voter Id"};
	             c3=new JComboBox(id);
		...
		JPanel p6 = new JPanel();
				...
				c3.setFont(new Font("TIMES NEW ROMAN",Font.BOLD,17));
			...
			else if(obj.getSource()==b1)
			{
										...
										try
										{
											...
											if(conn!=null)
											{
												...
												String idtype= (String)c3.getSelectedItem();
												...
												else
												{
												     ...
												     ps1.setString(6,idtype);   ps1.setString(7,id);  ps1.setString(8,cin);ps1.setString(9,sDate1);ps1.setInt(10,people);ps1.setInt(11,day);
												      ps2.setString(1,name);	ps2.setString(2,rno);  ps2.setString(3,type);  ps2.setString(4,addr);  ps2.setString(5,cont);
												  ps2.setString(6,idtype);    ps2.setString(7,id);  ps2.setString(8,cin);ps2.setString(9,sDate1);ps2.setInt(10,people);ps2.setInt(11,day); 
												}
